...
- (void)viewDidLoad
{
    ...
    [self.selectIndicatorView.pickedView setBackgroundColor:[UIColor whiteColor]];
    ...
    //0420
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(onDoneBtnClick:)];
}
...
- (NIMContactSelectTabView *)selectIndicatorView{
    ...
    //0420
    _selectIndicatorView.backgroundColor = [UIColor whiteColor];
    return _selectIndicatorView;
}
@end
