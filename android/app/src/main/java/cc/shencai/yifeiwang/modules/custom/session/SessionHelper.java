package cc.shencai.yifeiwang.modules.custom.session;
...
import cc.shencai.yifeiwang.modules.custom.DemoCache;
import cc.shencai.yifeiwang.modules.custom.session.action.FileAction;
import cc.shencai.yifeiwang.modules.custom.session.action.GuessAction;
import cc.shencai.yifeiwang.modules.custom.session.action.RTSAction;
import cc.shencai.yifeiwang.modules.custom.session.action.SnapChatAction;
import cc.shencai.yifeiwang.modules.custom.session.action.TipAction;
import cc.shencai.yifeiwang.modules.custom.session.extension.CustomAttachParser;
import cc.shencai.yifeiwang.modules.custom.session.extension.StickerAttachment;
...
//                actions.add(new AVChatAction(AVChatType.AUDIO));//视频功能，暂时不需要
