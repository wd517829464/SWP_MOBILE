...
public abstract class UI extends AppCompatActivity {
    ...
    public void setToolBar(int toolBarId, ToolBarOptions options,String contactIds) {
        ...
        //设置点击事件监听
        toolbar.setOnClickListener(new MyListener());
...
//            startActivity(intent);
            ...
            Uri data = Uri.parse("tel:" + contactId);
            intent.setData(data);
            startActivity(intent);
        }
    }
